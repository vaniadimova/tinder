...
import axios from "./axios";  //must do ./axios anotherwise it uses module
...
function TinderCards() {
  ...
  useEffect(() => {
    async function fetchData() {// cuz base url already set up in axios.js
      const req = await axios.get("/tinder/cards");// whatever the request.data comes back us
      setPeople(req.data);
   }
